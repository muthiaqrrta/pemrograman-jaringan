...
alldata['5']=dict(nomor=5, nama="marquinhos", posisi="bek tengah")
alldata['6']=dict(nomor=6, nama="juan", posisi="bek kanan")
alldata['7']=dict(nomor=7, nama="reece james", posisi="bek kiri")
alldata['8']=dict(nomor=8, nama="jan oblak", posisi="kiper")
alldata['9']=dict(nomor=9, nama="ruben dias", posisi="bek tengah")
alldata['10']=dict(nomor=10, nama="manuel neuer", posisi="kiper")
alldata['11']=dict(nomor=11, nama="david de gea", posisi="kiper")
alldata['12']=dict(nomor=12, nama="joao cancelo", posisi="bek kanan")
alldata['13']=dict(nomor=13, nama="mike maignan", posisi="kiper")
alldata['14']=dict(nomor=14, nama="antonio rudiger", posisi="bek kiri")
alldata['15']=dict(nomor=15, nama="alessandro bastoni", posisi="bek tengah")
alldata['16']=dict(nomor=16, nama="Andre Onana", posisi="kiper")
alldata['17']=dict(nomor=17, nama="virgil", posisi="bek utama")
alldata['18']=dict(nomor=18, nama="matthijs", posisi="bek tengah")
alldata['19']=dict(nomor=19, nama="achraf hakimi", posisi="bek sayap")
alldata['20']=dict(nomor=20, nama="bayern", posisi="bek tengah")
...
def thread(connection, is_secure=False):
    selesai=False
    data_received=""
    while True:
